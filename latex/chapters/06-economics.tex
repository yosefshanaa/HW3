...
% The rule of thumb is typeset as RTL Hebrew text with inline math islands (not
% a single LTR \[..\] display), so the Hebrew clause "זמן החזר ה-CAC ≤ 12 חודשים"
% reads in correct right-to-left order. Each $...$ stays an upright LTR island.
\begin{formulabox}
$\dfrac{\mathrm{LTV}}{\mathrm{CAC}} \geq 3$ \qquad וגם \qquad
זמן החזר ה-\en{CAC} $\leq$ 12 חודשים
\end{formulabox}
